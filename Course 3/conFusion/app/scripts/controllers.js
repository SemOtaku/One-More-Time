...
angular.module('confusionApp')
        ...
        .controller('ContactController', ['$scope', function($scope) {
            ...
            $scope.feedback = {mychannel:null, firstName:"", lastName:"", agree:false, email:"" };
        ...
        .controller('IndexController', ['$scope', '$stateParams', 'menuFactory', 'corporateFactory', function ($scope, $stateParams, menuFactory, corporateFactory) {
            ...
            $scope.dishFeat = menuFactory.getDishes().get({id:0}).$promise.then(
                function (response) {
                    $scope.dishFeat = response;
                    $scope.showDish = true;
                },
                function (response) {
                    $scope.message = "Error: " + response.status + " " + response.statusText;
            ...
            $scope.dishPromo =  menuFactory.getPromotion().get({id:0}).$promise.then(
                function (response) {
                    $scope.dishPromo = response;
